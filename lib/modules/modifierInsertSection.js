...
const regexModifierLine =
	/<insert-markup>(([0-9\.]*)\-?([0-9]*))<\/insert-markup>/m;

module.exports = function (Handlebars) {
	"use strict";

	Handlebars.registerHelper(
		"modifierInsertSection",
		function (markup, sections, styleGuide, sourcePath) {
			let markupNumber;
